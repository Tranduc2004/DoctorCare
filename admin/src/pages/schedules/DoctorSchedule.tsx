            ...
            <div className="flex-1">
              ...
              {error.includes("Xung đột lịch") && (
                <div className="mt-2 text-sm text-red-700">
                  💡 <strong>Giải pháp:</strong> Tick chọn "Bỏ qua kiểm tra xung
                  đột lịch (Force Replace)" trong modal thay thế bác sĩ để bỏ
                  qua kiểm tra này.
                </div>
              )}
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-white/50 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-white">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <div className="text-sm text-blue-100">Tổng ca làm việc</div>
                ...
                {timeSlots.map((time) => (
                  <React.Fragment key={time}>
                    ...
                    {dates.map((date) => {
                      ...
                      const dataset = selectedDoctorId ? shifts : globalShifts;
            ...
            <div className="bg-blue-50 border-t border-blue-200 p-4">
              <p className="text-blue-700 text-sm flex items-center gap-2">
                ...
                <strong>Hướng dẫn:</strong> Click vào các ô xanh để chọn múi giờ
                trống, sau đó nhấn "Tạo ca" để tạo ca làm việc.
                <br />
                <span className="text-red-600">
                  ⚠️ Ô đỏ = Không thể tạo ca (đã có ca hoặc ca của bác sĩ khác)
                </span>
              </p>
            </div>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  ...
                  {(selectedDoctorId ? shifts : globalShifts).length === 0 && (
                    <tr>
                      <td
            ...
            <div className="space-y-4">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <ul className="mt-2 space-y-1 list-disc list-inside">
                    ...
                    <li>
                      ...
                      lịch làm việc vào thời gian này, hệ thống sẽ từ chối thay
                      thế
                    </li>
                    <li>
                  ...
                  <div className="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <div className="text-sm text-yellow-800">
                      <strong>💡 Lưu ý:</strong> Khi sử dụng Force Replace, bác
                      sĩ mới có thể có 2 ca làm việc cùng lúc. Chỉ sử dụng khi
                      thực sự cần thiết.
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                >
                  ...
                  {doctors
                    .filter(
                      (d) => d._id !== selectedShiftForReplacement.doctorId?._id
                    )
                    .map((d) => (
                      <option key={d._id} value={d._id}>
                        {d.name || d.email}{" "}
              ...
              <div className="space-y-2">
                ...
                {!forceReplace && (
                  <div className="ml-7 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <div className="text-sm text-yellow-800">
                      <strong>Lưu ý:</strong> Nếu bác sĩ mới đã có lịch làm việc
                      vào thời gian này, hệ thống sẽ từ chối thay thế. Tick chọn
                      "Force Replace" để bỏ qua kiểm tra này.
                    </div>
                  </div>
                )}
                ...
                {forceReplace && (
                  <div className="ml-7 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                    <div className="text-sm text-orange-800">
                      <strong>⚠️ Cảnh báo:</strong> Bạn đã chọn bỏ qua kiểm tra
                      xung đột lịch. Điều này có thể tạo ra xung đột lịch làm
                      việc cho bác sĩ mới.
                    </div>
                  </div>
                )}
