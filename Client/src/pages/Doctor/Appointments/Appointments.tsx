                          ...
                          {safeStatus === "confirmed" && (
                            <button
                              onClick={async () => {
                                ...
                                try {
                                  const r = await fetch(
                                    `http://localhost:5000/api/patient/appointments/${appointment._id}/checkin`,
                                    {
                                      method: "POST",
                                      headers: {
                                        "Content-Type": "application/json",
            ...
            <div className="flex items-center justify-end gap-2">
              ...
              <button
                onClick={async () => {
                  ...
                  try {
                    const r = await fetch(
                      `http://localhost:5000/api/doctor/appointments/${reschedAppointment._id}/request-reschedule`,
                      {
                        method: "POST",
                        headers: {
                          "Content-Type": "application/json",
