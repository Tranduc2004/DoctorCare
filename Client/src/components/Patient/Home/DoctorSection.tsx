...
export default function DoctorSection() {
  ...
  return (
    <motion.section
      ...
      className="relative overflow-hidden bg-[#E8F7F5] py-16"
    ...
    >
      ...
      <div className="mx-auto max-w-6xl px-6 relative">
        ...
        >
          <Link
            to="/doctors"
            className="inline-flex items-center justify-center rounded-full bg-teal-500 px-6 py-3 font-semibold text-white shadow-[0_10px_24px_rgba(16,185,129,0.25)] transition-colors hover:bg-teal-600"
          >
            Xem tất cả bác sĩ
          </Link>
        </motion.div>
