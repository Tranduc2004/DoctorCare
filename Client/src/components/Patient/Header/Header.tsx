  ...
  useLayoutEffect(() => {
    ...
    if (isMenuOpen) {
      ...
      if (menuAnimation !== "hidden") {
        ...
        }, 700); // Increased timeout to match animation duration
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              className="ml-2 hover:text-teal-500 transition-all duration-300 relative group"
              onClick={openMenu}
              aria-label="Mở menu"
            >
              ...
              <div className="w-7 h-7 flex flex-col justify-center items-center">
                <div
                  className={`w-6 h-0.5 bg-gray-600 group-hover:bg-teal-500 transition-all duration-300 transform origin-center ${
                    isMenuOpen ? "rotate-45 translate-y-1.5" : ""
                  }`}
                />
                <div
                  className={`w-6 h-0.5 bg-gray-600 group-hover:bg-teal-500 my-1 transition-all duration-300 ${
              ...
              {isAuthenticated && user?.role === "patient" && unread > 0 && (
                <span className="absolute -top-1 -right-1 inline-flex items-center justify-center rounded-full bg-red-500 text-white text-[10px] leading-none px-1.5 py-0.5 min-w-[18px] h-[18px] animate-pulse">
                  {unread > 99 ? "99+" : unread}
                </span>
              )}
            </button>
      ...
      {menuAnimation !== "hidden" && (
        ...
        >
          <div
            className={`absolute inset-0 bg-black/40 backdrop-blur-sm transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${
              menuAnimation === "visible"
                ? "opacity-100"
                : menuAnimation === "closing"
                ? "opacity-0"
          ...
          <div
            ref={menuRef}
            className={`fixed right-0 top-0 h-full w-full max-w-sm bg-white shadow-2xl rounded-l-3xl flex flex-col z-50 transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] transform-gpu will-change-transform ${
              menuAnimation === "visible"
          ...
          >
            <button
              className="absolute top-4 right-4 text-gray-500 hover:text-gray-800 transition-all duration-300 hover:rotate-90 hover:scale-110"
              onClick={closeMenu}
            ...
            <div
              className={`flex flex-col items-center mt-8 mb-6 transition-all duration-500 ease-out ${
                menuAnimation === "visible"
            ...
            >
              ...
              {isAuthenticated && user && (
                <div
                  className={`mt-2 text-gray-700 font-semibold text-center transition-all duration-500 ${
                    menuAnimation === "visible"
            ...
            <nav
              className={`flex-1 flex flex-col gap-1 px-4 overflow-y-auto transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${
                menuAnimation === "visible"
            ...
            >
                ...
                <>
                  <div className="mt-4 p-4 pl-2">
                    ...
                    <ul className="space-y-2">
                      ...
                      <li>
                        <MenuLink
                          icon={<Pill className="text-teal-600" size={18} />}
                          to="/prescriptions/my"
                          onClick={closeMenu}
                          className="px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg"
                        >
              ...
              {/* Phần footer menu */}
              <div
                className={`mt-auto border-t transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${
                  menuAnimation === "visible"
  ...
  return (
    <>
      {links.map((link, index) => {
        const delayMs = isVisible ? 100 + index * 80 : 0;
        const transitionClasses =
          "transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] hover:text-teal-500 hover:border-teal-500 border-b-2 border-transparent hover:scale-105 hover:translate-x-2";
          ...
          <div className="py-2 max-h-72 overflow-auto">
            {specialties.map((s) => (
              <MenuLink
                ...
                onClick={onClick}
                className="w-full !px-4 !py-2 text-sm hover:bg-teal-500 hover:border-teal-500 hover:text-white border-b-2 border-transparent"
              >
                {s.name}
              </MenuLink>
            ))}
