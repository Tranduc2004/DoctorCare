...
export default function FloatingChatWidget() {
  ...
  const load = async () => {
    ...
    try {
      ...
      const prevLast = lastPolledIdRef.current;
  ...
  return (
    <>
      ...
      {/* Panel */}
      {open && (
        <div className="fixed bottom-20 right-5 w-[92vw] max-w-sm rounded-2xl border border-slate-200 bg-white shadow-2xl overflow-hidden">
          {/* Header */}
