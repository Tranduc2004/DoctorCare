...
// ✅ Factory functions
export function getMedicineModel(conn: Connection) {
  return conn.model<IMedicine>("Medicine", medicineSchema);
}

export function getMedicineBatchModel(conn: Connection) {
  return conn.model<IMedicineBatch>("MedicineBatch", medicineBatchSchema);
}

export function getStockTransactionModel(conn: Connection) {
  return conn.model<IStockTransaction>(
    "StockTransaction",
    stockTransactionSchema
  );
}

export function getMedicineStockModel(conn: Connection) {
  return conn.model<IMedicineStock>("MedicineStock", medicineStockSchema);
}
