...
exports.buildVietQR = buildVietQR;
exports.renderQrDataUrl = renderQrDataUrl;
...
function buildVietQR({ accountNumber, bankName, beneficiaryName, amount, // number in VND
note, }) {
    ...
    if (accountNumber)
        maiSub.push(tlv("01", accountNumber));
    if (bankName)
        maiSub.push(tlv("02", bankName));
...
exports.default = { buildVietQR, renderQrDataUrl };
