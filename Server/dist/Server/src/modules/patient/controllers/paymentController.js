...
const confirmVNPayFromClient = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        console.log("VNPay client confirmation received:", {
            body: req.body,
            rawQuery: (_a = req.body) === null || _a === void 0 ? void 0 : _a.rawQuery,
        });
        ...
        if (verificationResult.isSuccess) {
            ...
            const payment = yield Payment_1.default.create({
                ...
                vnpayTxnRef: vnp_TxnRef,
                vnpayResponseCode: vnp_ResponseCode,
                description: `Thanh toán VNPay thất bại - Mã giao dịch: ${vnp_TransactionNo || "N/A"}`,
                failedAt: new Date(),
            });
            // Update invoice status
            invoice.status = appointment_1.PaymentStatus.FAILED;
...
const handlePayosWebhook = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const foundSignatureRaw = payload && typeof payload.signature === "string" ? payload.signature : "";
        ...
        let data;
        try {
            data = yield payosClient.webhooks.verify(payload);
        }
        catch (verifyErr) {
            let expectedSignature = null;
            try {
                expectedSignature =
                    (yield payosClient.crypto.createSignatureFromObj(payload.data, payosClient.checksumKey)) || null;
            }
            catch (sigErr) {
        ...
        const code = String((_c = (_b = (_a = payload.code) !== null && _a !== void 0 ? _a : payload.status) !== null && _b !== void 0 ? _b : data === null || data === void 0 ? void 0 : data.code) !== null && _c !== void 0 ? _c : "").trim();
